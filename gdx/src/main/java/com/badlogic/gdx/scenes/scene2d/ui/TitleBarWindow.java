...
public class TitleBarWindow extends Table {
    ...
    private TitleBarWindowStyle style;
    ...
    public TitleBarWindow (String title, Skin skin) {
        this(title, skin.get(TitleBarWindowStyle.class));
        setSkin(skin);
    }

    public TitleBarWindow (String title, Skin skin, String styleName) {
        this(title, skin.get(styleName, TitleBarWindowStyle.class));
        setSkin(skin);
    }

    public TitleBarWindow (String title, TitleBarWindowStyle style) {
        ...
        titleTable.setBackground(style.titleBarDrawable);
        addActor(titleTable);
    ...
    /** Returns the window's style. Modifying the returned style may not have an effect until {@link #setStyle(TitleBarWindowStyle)} is
     * called. */
    public TitleBarWindowStyle getStyle () {
        return style;
    }
    ...
    static public class TitleBarWindowStyle extends Window.WindowStyle {
        /** The drawable to use for the title */
        public Drawable titleBarDrawable;

        /** The height of the bar. It is given as a percent, relative to the window. By default, it is
         * 0.1, which  means 10% of the window is meant to be the title bar.
         */
//        public float titleBarHeight = 0.1f;

        public TitleBarWindowStyle () {	}

        public TitleBarWindowStyle (BitmapFont titleFont, Color titleFontColor, Drawable background, Drawable titleBarBG) {
            super(titleFont, titleFontColor, background);
            this.titleBarDrawable = titleBarBG;
//            this.titleBarHeight = titleBarHeight;
        }

        public TitleBarWindowStyle (TitleBarWindowStyle style) {
            this(style.titleFont, new Color(style.titleFontColor), style.background, style.titleBarDrawable);
        }
    }
